...
⭐ **종합 운세 평가 (별 5개 만점)**
- 재물운: ⭐⭐⭐⭐⭐ (별 개수로 표시, 평균 4개 이상 권장)
- 애정운: ⭐⭐⭐⭐⭐ (별 개수로 표시, 평균 4개 이상 권장)
- 건강운: ⭐⭐⭐⭐⭐ (별 개수로 표시, 평균 4개 이상 권장)
- 직업운: ⭐⭐⭐⭐⭐ (별 개수로 표시, 평균 4개 이상 권장)
- 종합 평가: 한 줄 긍정적 요약
...
3. **긍정 85% + 현실적 조언 15%** 비율 유지 (후하게 평가)
4. **별점은 평균 4개 이상** 주기 (3.5개 미만 금지)
